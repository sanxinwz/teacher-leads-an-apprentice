<template>
    <div class="container-fuild bg-white w-100 p-3">
        ...
        <div class="row">
            ...
            <div class="col-2 text-left mb-3">
              <input class="form-control" placeholder="请输入课程编号" />
            </div>
            <div class="col-2 text-left mb-3">
        ...
        <div class="row">
            <div class="col-12 text-left mb-3">
                <button @click="showAdd()" class="btn btn-sm btn-outline-primary mr-3 text-black-50" style="border-color: #1A4888"><i class="fa fa-plus fa-fw mr-1"></i>新增课程</button>
            ...
            <div class="col-12">
                ...
                >
                    <template v-slot:cell(id)="data">
                        <button  @click="showEdit(data.item)" class="btn btn-primary btn-sm mr-2" style="background-color: #1A4888"><i class="fa fa-edit fa-fw mr-1"></i>编辑</button>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 d-flex flex-row mb-2">
                        ...
                        <div style="flex: 1">
                          <input type="text" class="form-control" v-model="courseEdit.ser" />
                        </div>
                    </div>
                    <div class="col-12 d-flex flex-row mb-2">
        ...
        <b-modal id="importcourse" title="导入课程" size="lg">
            <template v-slot:modal-footer="{ }">
                ...
                <b-button size="sm" variant="success" style="background-color: #1A4888" @click="ok('importcourse')">
                    确定导入
                </b-button>
            </template>
            <div class="card">
